...
\begin{frame}[label=current]%
    \begin{figure}%
        \begin{tikzpicture}
        \temporal<2>{
                \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.55\textwidth]{figures/3030imag_contour_py.pdf}};
            }{
                \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.55\textwidth]{figures/3030real_contour_py.pdf}};
            }{
