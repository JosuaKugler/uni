...
tikzplotlib.save("figures/half_absolute_value_contour.tex")


fig2 = plt.figure(figsize = (15,15))
plt.contour(realpoints, 100, linewidths=0.5, origin='lower', extent=[rmin, rmax, imin, imax])
tikzplotlib.save("figures/half_real_value_contour.tex")
...
#plt.contour(imagpoints, 100, linewidths=0.5, origin='lower', extent=[rmin, rmax, imin, imax])
#tikzplotlib.save("figures/half_imag_value_contour.tex")
#plt.show()
