...
\]
i.e. $f^{-1}(0) \cap S^{2n-1} \subset \mathbb C^n$ for $f(z_1, \dots, z_n) = z_1^k + z_2^2 + \dots + $.
...
Therefore, we obtain a contact manifold that is smoothly diffeomorphic to a sphere (by the
h-cobordism theorem).
