The main ingredients for the next section come from the theory of convex hypersurfaces.
...
Start with a Bourgeois manifold $M \times T^2$ where the open book decomposition of $M$ has pages $\Sigma$.
Smoothly,
\[
    M \times T^2 
