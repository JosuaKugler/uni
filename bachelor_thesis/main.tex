...
%Use the a_n values, introduce the L-function of an elliptic curve
%\color{black}
...
\begin{proposition}\cite[chapter 1, theorem 2.11]{Cornell1997}\label{prop:rhoEpproperties} 
    ...
    \[
        \overline{\rho_{E,p}}\colon G_Q \to \GL_2(\mathbb{Z}/p\mathbb{Z})  
    \]
    the following equivalences hold.
    \begin{itemize}
        \item \(\overline{\rho_{E,p}}\) is flat at \(p\) \(\Leftrightarrow p| \operatorname{ord}_p(\Delta_E)\).
        \item For any prime \(\ell \neq p\): 
        \(\overline{\rho_{E,p}}\) is unramified at \(\ell\) \(\Leftrightarrow p| \operatorname{ord}_\ell(\Delta_E)\).
    \end{itemize}
\end{proposition}
%analogously, we can associate a galois representation to each newform
...
\begin{lemma}\textup{\cite[see][lemma 5.14]{Darmon1995}}
    The map
    \begin{align*}
