...
\begin{proof}
    \begin{enumerate}
        ...
        \end{align*}
        by using linearity multiple times.%Explain in greater detail
        ...
        As this condition is satisfied by \(\hom_\mathcal{O}(A, \mathcal{O})\) and \(A\) (\textbf{Why?}), the lemma follows.
    \end{enumerate}
\end{proof}
