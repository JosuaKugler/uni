...
\begin{definition}[depth]
    The depth of a local noetherian ring \(R\) is defined as the maximum length of
    a regular sequences in \(R\).(in m?)
\end{definition}

\begin{theorem}%cite bruns herzog
...
\begin{proof}
    ...
    Consider \(g' = \lambda^{m-1}u g\). If \(g'\) is still zero, define \(g''\coloneqq \lambda^{m-2}u g\).
...
\begin{proof}
    \begin{enumerate}
        ...
        We have \cite[cf.][\href{https://stacks.math.columbia.edu/tag/05G3}{lemma 10.14.3}]{stacks-project}
        \[
            \hom_\mathcal{O}(A, \mathcal{O}[[\underline{X}]])
            \cong \hom_{\mathcal{O}[[\underline{X}]]}(A[[\underline{X}]], \mathcal{O}[[\underline{X}]])  
        \]
        as \(\mathcal{O}[[\underline{X}]]\)-modules.
        Because of
        \[
            \hom_\mathcal{O}(A, \mathcal{O}[[\underline{X}]]) 
        ...
        an \(\mathcal{O}\)-basis \(f_1, \dots, f_r\) of \(\hom_\mathcal{O}(A, \mathcal{O})\) is 
        an \(\mathcal{O}[[\underline{X}]]\)-basis of \(\hom_\mathcal{O}(A, \mathcal{O}[[\underline{X}]])\).
        By base change, the extended maps \(\tilde f_1, \dots \tilde f_r\) form an \(\mathcal{O}[[\underline{X}]]\)-basis
        of \(\hom_{\mathcal{O}[[X]]}(A[[\underline{X}]], \mathcal{O}[[\underline{X}]])\).
        %Indeed, let 
        %\(f \in \hom_{\mathcal{O}[[X]]}(A[[\underline{X}]], \mathcal{O}[[\underline{X}]])\).
        %We give the argument for one variable, however for more variables the proof is completely
        %analogous.
        %Using \(\mathcal{O}[[\underline{X}]]\)-linearity, we have
        %\[
        %    f(X) = X \cdot f(1) = X \cdot \sum_{i=1}^r \alpha_i f_i(1) = \sum_{i=1}^r X \alpha_i \cdot f_i(1) 
        %    = \sum_{i=1}^r \alpha_i \tilde f_i(X),
        %\]
        %\(\alpha_i \in \mathcal{O}\).
        From \cref{lem:surjectivity} we know that the map 
        \[
            \Phi\colon \hom_{\mathcal{O}[[\underline{X}]]}(A[[\underline{X}]], \mathcal{O}[[\underline{X}]]) \to A
        \]
        is surjective.
