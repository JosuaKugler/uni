...
%add something on this weird properties
...
\end{definition}
%\begin{definition}
%    A Galois representation \(\rho\) is \textbf{irreducible}
%\end{definition}
...
\begin{proof}
    ...
    \[
        V = SDT  
    \]
    for some diagonal matrix \(D = \begin{pmatrix}
        d_1&&\\
        &\ddots&\\
        &&d_n
    \end{pmatrix}\) (Smith normal form).
