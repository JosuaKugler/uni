...
\[
    \begin{tikzcd}
        \hom(R_\Sigma, A) = \mathcal{R}_\Sigma(A) \arrow[r, equals]& \{\overline{\rho}\text{-deformations } \rho \colon G_\mathbb{Q} \to \GL_2(A) \text{ of type }\Sigma\}\\
        \hom(\mathbb{T}_\Sigma, A) = \mathcal{T}_\Sigma(A) \arrow[r, equals]& \{\text{cuspidal newforms  \(f\) s.t. \(\rho_f\) is of type \(\Sigma\)}\}\arrow[u, hook]
    \end{tikzcd}
\]
