...
\begin{remark}\label{rem:noconstant}
    For a finite flat complete intersection \(A \in \cob\) we can even choose the quotient
    \[
    ...
    \]
    %add some note on the f_i not having constant term or so
    %in order to be surjective, the relations f_i can't have a constant term, because otherwise two polynomials with different constant term had the same residue class mod f_i => pi_A wouldn't be surjective
\end{remark}
\begin{proof}
    %TODO
\end{proof}
